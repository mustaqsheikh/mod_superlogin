		...
		<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" name="login">
			<span class="logout">
				...
				<span class="logout-button<?php echo "-" . $logout_button ?>">
					<button value="<?php if( $logout_button == "text" ) { echo JText::_('BUTTON_LOGOUT'); } ?>" name="Submit" type="submit" title="<?php echo JText::_('BUTTON_LOGOUT'); ?>">
			...
			<span class="login">
				...
				<span class="login-button-container">
					<span class="login-button<?php echo "-" . $login_button ?>">
						<button value="<?php if( $login_button == "text" ) { echo JText::_('BUTTON_LOGIN'); } ?>" name="Submit" type="submit" title="<?php echo JText::_('BUTTON_LOGIN'); ?>">
							<?php if( $login_button == "text" ) { echo JText::_('BUTTON_LOGIN'); } ?>
						</button>
					</span>
				</span>
				<?php if( $lost_password ) { ?>
					<span class="lostpassword">
						<a href="<?php echo JRoute::_($prlink); ?>" title="<?php echo JText::_('FORGOT_YOUR_PASSWORD'); ?>"></a>
					</span>
				<?php } ?>
				<?php if( $lost_username ) { ?>
					<span class="lostusername">
						<a href="<?php echo JRoute::_($urlink); ?>" title="<?php echo JText::_('FORGOT_YOUR_USERNAME'); ?>"></a>
					</span>
				<?php } ?>
				<?php
